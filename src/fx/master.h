...
class MasterChain {
 public:
  ...
  void Init(float sr) {
    ...
    sm_vol_ = vol_; sm_cut_ = cut01_; sm_res_ = res01_;
 ...
 private:
  ...
  inline void DcBlock(float& l, float& r) {
    float yl = l - dcx_l_ + dc_r_ * dcy_l_; dcx_l_ = l; dcy_l_ = yl; l = yl;
    float yr = r - dcx_r_ + dc_r_ * dcy_r_; dcx_r_ = r; dcy_r_ = yr; r = yr;
  }
  ...
  float dc_r_ = 0.9974f, dcx_l_ = 0.0f, dcy_l_ = 0.0f, dcx_r_ = 0.0f, dcy_r_ = 0.0f;  // DC blocker
  int   type_ = OFF;
};
